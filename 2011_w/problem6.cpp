...
string Game::select_strongPlace() {
    ...
    for (int cnt = 0; cnt < 9; cnt++) {
        ...
        if (state.at(cnt / 3).at(cnt % 3) == 2) {
            ...
            int tmp = priority.at(who_wins(p));
            if (boarder <= tmp) {
